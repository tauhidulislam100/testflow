          ...
          <div className="flex flex-row items-center justify-end gap-1">
            ...
            >
              <button
                ...
                aria-haspopup="menu"
                aria-expanded={isDropdownOpen} // Update aria-expanded based on state
                aria-label="Dropdown"
              ...
              <div
                className={`hs-dropdown-menu transition-[opacity,margin] duration ${
                  isDropdownOpen
                    ? "opacity-100 fixed top-12 right-4"
                    : "opacity-0 hidden"
                } min-w-60 bg-white shadow-md rounded-lg mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full`}
                role="menu"
              ...
              >
                ...
                <div className="p-1.5 space-y-0.5">
                  ...
                  <button
                    className="flex w-full items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100"
