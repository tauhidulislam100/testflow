                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={form.email}
                      className="py-2.5 sm:py-3 px-4 block w-full border-2 border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                      required
                ...
                {/* <div className="flex items-center">
                  <div className="flex">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="shrink-0 mt-0.5 rounded-sm text-blue-600 focus:ring-blue-500 border border-blue-400"
                    />
                  </div>
                  <div className="ms-3">
